...
% thesis/dissertation.
\collegesubmittedto{Information Sciences and Technology}
...
\readerthree[Graduate Program Chair]
			{Andrea Tapia}
			{Associate Professor of Information Sciences and Technology}
...
%%%%%%%%%%%%%%%%%%%%%%
% Chapters
\include{Chapter-intro/Chapter-1}
\include{Chapter-preliminary/Chapter-2}
\include{Chapter-embedding/Chapter-3}
\include{Chapter-partition/Chapter-4}
\include{Chapter-non-stationary/Chapter-5}
\include{Chapter-conclusion/Chapter-6}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Appendices
%
...
% bibtex, then this section should look something like:
	...
	\bibliography{Biblio-Database,ref-crime,dynamic-embedding,chicago-partition}
	\end{singlespace}
